    ...
    return (<Fragment>
        ...
        <svg viewBox="0 0 0 0" 
            ...
            <defs>
                ...
                <path id="todo_check" d="M10 13l12 2 5-5"/>
                <path id="todo_box" d="M21 12.7v5c0 1.3-1 2.3-2.3 2.3H8.3C7 20 6 19 6 17.7V7.3C6 
                6 7 5 8.3 5h10-4C20 5 21 6 21 7.3v5.4"/>
        ...
        <label className="todo new-item">
            ...
            <svg 
                ...
                viewBox="0 0 200 25" className="todo_icon">
